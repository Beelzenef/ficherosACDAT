...
/**
 * Escribiendo en memoria externa, si esta existe
 * @author Elena G (Beelzenef)
 */
public class EscribirMemExtActivity extends AppCompatActivity {
    ...
    void EscribiendoMemExt() {
        if (miEscribirMemorias.disponibleEscritura()) {
            if (miEscribirMemorias.escribirExterna(NOMBREFICHERO, textoAEscribir, false, "UTF-8"))
                txtV_PropiedadesFichero.setText(miEscribirMemorias.mostrarPropiedadesExterna(NOMBREFICHERO));
            else
